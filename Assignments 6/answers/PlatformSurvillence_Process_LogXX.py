...
def PlatformSurvillence(folderName):
    ...
    for info in data:
        ...
        fobj.write("User Name: "+str(info.get("username"))+"\n")
        fobj.write("Status: "+str(info.get("status"))+"\n")
        fobj.write("CPU Usage: "+str(info.get("cpu_prcent"))+"\n")
        fobj.write("RAM Usage: "+str(info.get("memory_percent"))+"\n")
        fobj.write(border+"\n")
